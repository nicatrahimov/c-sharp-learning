...
public class ProductRepo : IProductRepo
{
    ...
    {
        var query = "select * from testapi.product";
    ...
    public Product GetProductById(Guid id)
    {
        ...
        using (var connection = _context.CreateConnection())
        {
            var product = connection.QueryFirstOrDefault<Product>(query, parameter);
            return product;
        }
    }
    ...
    public int EditProduct(Guid id, Product product)
    {
        var query = "UPDATE testapi.product SET ";
    ...
    {
        var query = "delete from testapi.product where id=@id";
        var parameter = new DynamicParameters();
        parameter.Add("id", id);
        using (var connection = _context.CreateConnection())
        {
